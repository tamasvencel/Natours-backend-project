...
})({"vWvvG":[function(require,module,exports) {
...
/* eslint-disable */ /*because it is configured for node.js */ var _polyfill = require("@babel/polyfill");
...
if (userPasswordForm) userPasswordForm.addEventListener("submit", async (e)=>{
    ...
    await (0, _updateUserData.updateData)({
        passwordCurrent,
        password,
        passwordConfirm
    }, "password");
...
},{"@babel/polyfill":"dTCHC","./login":"7yHem","./signup":"fNY2o","./map":"GDuAq","./updateUserData":"hFIIY","./stripe":"10tSC"}],"dTCHC":[function(require,module,exports) {
"use strict";
...
/* eslint-disable */ /*because it is configured for node.js */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const logout = async ()=>{
    try {
        ...
        (0, _alerts.showAlert)("error", "Error when logging out! Try again.");
    }
};
...
},{"axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"GDuAq":[function(require,module,exports) {
/* eslint-disable */ /*because it is configured for node.js */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alerts = require("./alerts");
const stripe = Stripe("pk_test_51NojgRFcZkqRpT2CJ0r1RzZoCcA3epvhnDaGeIdykiwdQJK40yMMZVkHFCXdoEMRuWntNinHOAlUznlkSw4W35AP00ltUSEWQk");
...
},{"axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["vWvvG","f2QDv"], "f2QDv", "parcelRequire11c7")
