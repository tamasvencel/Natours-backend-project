...
(f(t,d,c),E(r))?r instanceof $||(o=w(r))==H||o==Z?void 0!==i?new y(r,tj(n,e),i):void 0!==n?new y(r,tj(n,e)):new y(r):tO in r?tF(d,r):tI.call(d,r):new y(v(r)))}),tt(m!==Function.prototype?A(y).concat(A(m)):A(y),function(t){t in d||h(d,t,y[t])}),d[K]=x,r||(x.constructor=d));var j=x[tb],U=!!j&&("values"==j.name||void 0==j.name),k=tq.values;h(d,tE,!0),h(x,tO,c),h(x,tR,!0),h(x,tS,d),(u?new d(1)[tw]==c:tw in x)||V(x,tw,{get:function(){return c}}),S[c]=d,o(o.G+o.W+o.F*(d!=y),S),o(o.S,c,{BYTES_PER_ELEMENT:e}),o(o.S+o.F*i(function(){y.of.call(d,1)}),c,{from:tI,of:tB}),z in x||h(x,z,e),o(o.P,c,tC),B(c),o(o.P+o.F*tP,c,{set:tV}),o(o.P+!U*o.F,c,tq),r||x.toString==ty||(x.toString=ty),o(o.P+o.F*i(function(){new d(1).slice()}),c,{slice:tG}),o(o.P+o.F*(i(function(){return[1,2].toLocaleString()!=new d([1,2]).toLocaleString()})||!i(function(){x.toLocaleString.call([1,2])})),c,{toLocaleString:tD}),N[c]=U?j:k,r||U||h(x,tb,k)}}else t.exports=function(){}}),l.register("dRJbK",function(t,e){// all object keys, includes non-enumerable and symbols
...
var tm=b(function(){_.f(1)});g(g.S+g.F*tm,"Object",{getOwnPropertySymbols:function(t){return _.f(F(t))}}),// 24.3.2 JSON.stringify(value [, replacer [, space]])
Y&&g(g.S+g.F*(!tr||b(function(){var t=J();// MS Edge converts symbol values to JSON as {}
// WebKit converts symbol values to JSON as null
// V8 throws on boxed symbols
return"[null]"!=H([t])||"{}"!=H({a:t})||"{}"!=H(Object(t))})),"JSON",{stringify:function(t){for(var e,r,n=[t],i=1;arguments.length>i;)n.push(arguments[i++]);if(r=e=n[1],!(!k(e)&&void 0===t||ts(t)))return j(e)||(e=function(t,e){if("function"==typeof r&&(e=r.call(this,t,e)),!ts(e))return e}),n[1]=e,H.apply(Y,n);// IE8 returns string on undefined
...
var N=l("5hYYX"),C=l("dqZxD"),tb=C.f;l("dcCE6")("getOwnPropertyDescriptor",function(){return function(t,e){return tb(N(t),e)}});// 19.1.2.9 Object.getPrototypeOf(O)
var F=l("AEwlf"),tw=l("hGDaq");l("dcCE6")("getPrototypeOf",function(){return function(t){return tw(F(t))}});// 19.1.2.14 Object.keys(O)
...
var k=l("5epbW"),y=l("8ZJoP"),tE=y.onFreeze;l("dcCE6")("freeze",function(t){return function(e){return t&&k(e)?t(tE(e)):e}});// 19.1.2.17 Object.seal(O)
var k=l("5epbW"),y=l("8ZJoP"),tS=y.onFreeze;l("dcCE6")("seal",function(t){return function(e){return t&&k(e)?t(tS(e)):e}});// 19.1.2.15 Object.preventExtensions(O)
var k=l("5epbW"),y=l("8ZJoP"),tx=y.onFreeze;l("dcCE6")("preventExtensions",function(t){return function(e){return t&&k(e)?t(tx(e)):e}});// 19.1.2.12 Object.isFrozen(O)
var k=l("5epbW");l("dcCE6")("isFrozen",function(t){return function(e){return!k(e)||!!t&&t(e)}});// 19.1.2.13 Object.isSealed(O)
var k=l("5epbW");l("dcCE6")("isSealed",function(t){return function(e){return!k(e)||!!t&&t(e)}});// 19.1.2.11 Object.isExtensible(O)
var k=l("5epbW");l("dcCE6")("isExtensible",function(t){return function(e){return!!k(e)&&(!t||t(e))}});// 19.1.3.1 Object.assign(target, source)
...
tP in tT||l("kLGkJ")&&tA(tT,tP,{configurable:!0,get:function(){try{return(""+this).match(t_)[1]}catch(t){return""}}});var k=l("5epbW"),tw=l("hGDaq"),tj=l("iv1sY")("hasInstance"),tU=Function.prototype;tj in tU||l("l3ykp").f(tU,tj,{value:function(t){if("function"!=typeof this||!k(t))return!1;if(!k(this.prototype))return t instanceof this;// for environment w/o native `@@hasInstance` logic enough `instanceof`, but add this:
for(;t=tw(t);)if(this.prototype===t)return!0;return!1}});var g=l("27fei"),tk={},h=l("4VVRT"),tL=h.parseInt,tF=l("cnCL0"),tN=tF.trim,tI=l("joilI"),tB=/^[-+]?0[xX]/;tk=8!==tL(tI+"08")||22!==tL(tI+"0x16")?function(t,e){var r=tN(String(t),3);return tL(r,e>>>0||(tB.test(r)?16:10))}:tL,// 18.2.5 parseInt(string, radix)
g(g.G+g.F*(parseInt!=tk),{parseInt:tk});var g=l("27fei"),tM={},h=l("4VVRT"),tD=h.parseFloat,tF=l("cnCL0"),tC=tF.trim;tM=1/tD(l("joilI")+"-0")!=-1/0?function(t){var e=tC(String(t),3),r=tD(e);return 0===r&&"-"==e.charAt(0)?-0:r}:tD,// 18.2.4 parseFloat(string)
g(g.G+g.F*(parseFloat!=tM),{parseFloat:tM});var h=l("4VVRT"),p=l("5hs3T"),tG=l("gGVth"),tV=l("bfgnE"),I=l("h8che"),b=l("c69UQ"),tq=l("61NmY"),tW=tq.f,C=l("dqZxD"),tJ=C.f,G=l("l3ykp"),tY=G.f,tF=l("cnCL0"),tH=tF.trim,tZ="Number",tz=h[tZ],tK=tz,tX=tz.prototype,t$=tG(l("frHNq")(tX))==tZ,tQ="trim"in String.prototype,t0=function(t){var e=I(t,!1);if("string"==typeof e&&e.length>2){var r=(e=tQ?e.trim():tH(e,3)).charCodeAt(0);if(43===r||45===r){if(88===(n=e.charCodeAt(2))||120===n)return NaN;// Number('+0x1') should be NaN, old V8 fix
...
g(g.S+g.F*(Number.parseInt!=tk),"Number",{parseInt:tk});// 20.2.2.3 Math.acosh(x)
...
fromCodePoint:function(t){for(var e,r=[],n=arguments.length,i=0;n>i;){if(e=+arguments[i++],ex(e,1114111)!==e)throw RangeError(e+" is not a valid code point");r.push(e<65536?eO(e):eO(((e-=65536)>>10)+55296,e%1024+56320))}return r.join("")}});var g=l("27fei"),N=l("5hYYX"),eA=l("hxXsn");g(g.S,"String",{// 21.1.2.4 String.raw(callSite, ...substitutions)
raw:function(t){for(var e=N(t.raw),r=eA(e.length),n=arguments.length,i=[],o=0;r>o;)i.push(String(e[o++])),o<n&&i.push(String(arguments[o]));return i.join("")}}),// 21.1.3.25 String.prototype.trim()
...
codePointAt:function(t){return e_(this,t)}});var g=l("27fei"),eA=l("hxXsn"),eP={},ej={},k=l("5epbW"),tG=l("gGVth"),eU=l("iv1sY")("match");ej=function(t){var e;return k(t)&&(void 0!==(e=t[eU])?!!e:"RegExp"==tG(t))};var ek=l("akpHM");eP=function(t,e,r){if(ej(e))throw TypeError("String#"+r+" doesn't accept regex!");return String(ek(t))};var eL="endsWith",eF=""[eL];g(g.P+g.F*l("lzF4g")(eL),"String",{endsWith:function(t/* , endPosition = @length */){var e=eP(this,t,eL),r=arguments.length>1?arguments[1]:void 0,n=eA(e.length),i=void 0===r?n:Math.min(eA(r),n),o=String(t);return eF?eF.call(e,o,i):e.slice(i-o.length,i)===o}});var g=l("27fei"),eN="includes";g(g.P+g.F*l("lzF4g")(eN),"String",{includes:function(t/* , position = 0 */){return!!~eP(this,t,eN).indexOf(t,arguments.length>1?arguments[1]:void 0)}});var g=l("27fei");g(g.P,"String",{// 21.1.3.13 String.prototype.repeat(count)
...
var g=l("27fei");g(g.S,"Date",{now:function(){return new Date().getTime()}});var g=l("27fei"),F=l("AEwlf"),I=l("h8che");g(g.P+g.F*l("c69UQ")(function(){return null!==new Date(NaN).toJSON()||1!==Date.prototype.toJSON.call({toISOString:function(){return 1}})}),"Date",{// eslint-disable-next-line no-unused-vars
toJSON:function(t){var e=F(this),r=I(e);return"number"!=typeof r||isFinite(r)?e.toISOString():null}});// 20.3.4.36 / 15.9.5.43 Date.prototype.toISOString()
...
var g=l("27fei");g(g.S,"Array",{isArray:l("dGOhA")});var ez=l("iGnE2"),g=l("27fei"),F=l("AEwlf"),eK=l("8lgbK"),eX=l("51BdB"),eA=l("hxXsn"),e$={},G=l("l3ykp"),B=l("4TEjo");e$=function(t,e,r){e in t?G.f(t,e,B(0,r)):t[e]=r};var eQ=l("4a3PB");g(g.S+!l("ad6Gn")(function(t){Array.from(t)})*g.F,"Array",{// 22.1.2.1 Array.from(arrayLike, mapfn = undefined, thisArg = undefined)
from:function(t/* , mapfn = undefined, thisArg = undefined */){var e,r,n,i,o=F(t),a="function"==typeof this?this:Array,s=arguments.length,u=s>1?arguments[1]:void 0,f=void 0!==u,c=0,l=eQ(o);// if object isn't iterable or it's array with default iterator - use simple case
...
of:function(){for(var t=0,e=arguments.length,r=new("function"==typeof this?this:Array)(e);e>t;)e$(r,t,arguments[t++]);return r.length=e,r}});var g=l("27fei"),N=l("5hYYX"),e0=[].join;// fallback for not array-like strings
g(g.P+g.F*(l("g5dar")!=Object||!l("209KG")(e0)),"Array",{join:function(t){return e0.call(N(this),void 0===t?",":t)}});var g=l("27fei"),e1=l("ctFEK"),tG=l("gGVth"),ex=l("iSghg"),eA=l("hxXsn"),e2=[].slice;// fallback for not array-like ES3 strings and DOM objects
g(g.P+g.F*l("c69UQ")(function(){e1&&e2.call(e1)}),"Array",{slice:function(t,e){var r=eA(this.length),n=tG(this);if(e=void 0===e?r:e,"Array"==n)return e2.call(this,t,e);for(var i=ex(t,r),o=ex(e,r),a=eA(o-i),s=Array(a),u=0;u<a;u++)s[u]="String"==n?this.charAt(i+u):this[i+u];return s}});var g=l("27fei"),e6=l("i66st"),F=l("AEwlf"),b=l("c69UQ"),e5=[].sort,e4=[1,2,3];g(g.P+g.F*(b(function(){// IE8-
e4.sort(void 0)})||!b(function(){// V8 bug
e4.sort(null);// Old WebKit
})||!l("209KG")(e5)),"Array",{// 22.1.3.25 Array.prototype.sort(comparefn)
sort:function(t){return void 0===t?e5.call(F(this)):e5.call(F(this),e6(t))}});var g=l("27fei"),e3=l("a9Nrf")(0),e8=l("209KG")([].forEach,!0);g(g.P+!e8*g.F,"Array",{// 22.1.3.10 / 15.4.4.18 Array.prototype.forEach(callbackfn [, thisArg])
...
indexOf:function(t/* , fromIndex = 0 */){return ra?ro.apply(this,arguments)||0:ri(this,t,arguments[1])}});var g=l("27fei"),N=l("5hYYX"),t5=l("aarvP"),eA=l("hxXsn"),rs=[].lastIndexOf,ru=!!rs&&1/[1].lastIndexOf(1,-0)<0;g(g.P+g.F*(ru||!l("209KG")(rs)),"Array",{// 22.1.3.14 / 15.4.4.15 Array.prototype.lastIndexOf(searchElement [, fromIndex])
lastIndexOf:function(t/* , fromIndex = @[*-1] */){// convert -0 to +0
if(ru)return rs.apply(this,arguments)||0;var e=N(this),r=eA(e.length),n=r-1;for(arguments.length>1&&(n=Math.min(n,t5(arguments[1]))),n<0&&(n=r+n);n>=0;n--)if(n in e&&e[n]===t)return n||0;return -1}});// 22.1.3.3 Array.prototype.copyWithin(target, start, end = this.length)
...
rj=function(t,e,r){return e+(r?rU(t,e).length:1)};var rk={},tO=l("c5KT9"),rL=RegExp.prototype.exec;// `RegExpExec` abstract operation
// https://tc39.github.io/ecma262/#sec-regexpexec
rk=function(t,e){var r=t.exec;if("function"==typeof r){var n=r.call(t,e);if("object"!=typeof n)throw TypeError("RegExp exec method returned something other than an Object or null");return n}if("RegExp"!==tO(t))throw TypeError("RegExp#exec called on incompatible receiver");return rL.call(t,e)},// @@match logic
...
function(t){var e,i=n(r,t,this);if(i.done)return i.value;var o=U(t),a=String(this);if(!o.global)return rk(o,a);var s=o.unicode;o.lastIndex=0;for(var u=[],f=0;null!==(e=rk(o,a));){var c=String(e[0]);u[f]=c,""===c&&(o.lastIndex=rj(a,eA(o.lastIndex),s)),f++}return 0===f?null:u}]});var U=l("kvyZU"),F=l("AEwlf"),eA=l("hxXsn"),t5=l("aarvP"),rF=Math.max,rN=Math.min,rI=Math.floor,rB=/\$([$&`']|\d\d?|<[^>]*>)/g,rM=/\$([$&`']|\d\d?)/g;// @@replace logic
...
function(t,e){var i=n(r,t,this,e);if(i.done)return i.value;var o=U(t),a=String(this),s="function"==typeof e;s||(e=String(e));var u=o.global;if(u){var f=o.unicode;o.lastIndex=0}for(var c=[];;){var l=rk(o,a);if(null===l||(c.push(l),!u))break;""===String(l[0])&&(o.lastIndex=rj(a,eA(o.lastIndex),f))}for(var h="",p=0,d=0;d<c.length;d++){// NOTE: This is equivalent to
//   captures = result.slice(1).map(maybeToString)
// but for some reason `nativeSlice.call(result, 1, result.length)` (called in
// the slice polyfill when slicing native arrays) "doesn't work" in safari 9 and
// causes a crash (https://pastebin.com/N21QzeQA) when trying to debug it.
for(var g,v=String((l=c[d])[0]),y=rF(rN(t5(l.index),a.length),0),m=[],b=1;b<l.length;b++)m.push(void 0===(g=l[b])?g:String(g));var w=l.groups;if(s){var E=[v].concat(m,y,a);void 0!==w&&E.push(w);var S=String(e.apply(void 0,E))}else S=// https://tc39.github.io/ecma262/#sec-getsubstitution
function(t,e,n,i,o,a){var s=n+t.length,u=i.length,f=rM;return void 0!==o&&(o=F(o),f=rB),r.call(a,f,function(r,a){var f;switch(a.charAt(0)){case"$":return"$";case"&":return t;case"`":return e.slice(0,n);case"'":return e.slice(s);case"<":f=o[a.slice(1,-1)];break;default:var c=+a;if(0===c)return r;if(c>u){var l=rI(c/10);if(0===l)return r;if(l<=u)return void 0===i[l-1]?a.charAt(1):i[l-1]+a.charAt(1);return r}f=i[c-1]}return void 0===f?"":f})}(v,a,y,m,w,e);y>=p&&(h+=a.slice(p,y)+S,p=y+v.length)}return h+a.slice(p)}]});var U=l("kvyZU"),rD=l("fCJ6p");// @@search logic
...
function(t){var e=n(r,t,this);if(e.done)return e.value;var i=U(t),o=String(this),a=i.lastIndex;rD(a,0)||(i.lastIndex=0);var s=rk(i,o);return rD(i.lastIndex,a)||(i.lastIndex=a),null===s?-1:s.index}]});var U=l("kvyZU"),rC=l("93WgD"),eA=l("hxXsn"),rG=l("eov86"),b=l("c69UQ"),rV=Math.min,rq=[].push,rW="split",rJ="length",rY="lastIndex",rH=!b(function(){RegExp(4294967295,"y")});// @@split logic
...
// the 'y' flag.
function(t,e){var o=n(i,t,this,e,i!==r);if(o.done)return o.value;var a=U(t),s=String(this),u=rC(a,RegExp),f=a.unicode,c=(a.ignoreCase?"i":"")+(a.multiline?"m":"")+(a.unicode?"u":"")+(rH?"y":"g"),l=new u(rH?a:"^(?:"+a.source+")",c),h=void 0===e?4294967295:e>>>0;if(0===h)return[];if(0===s.length)return null===rk(l,s)?[s]:[];for(var p=0,d=0,g=[];d<s.length;){l.lastIndex=rH?d:0;var v,y=rk(l,rH?s:s.slice(d));if(null===y||(v=rV(eA(l.lastIndex+(rH?0:d)),s.length))===p)d=rj(s,d,f);else{if(g.push(s.slice(p,d)),g.length===h)return g;for(var m=1;m<=y.length-1;m++)if(g.push(y[m]),g.length===h)return g;d=p=v}}return g.push(s.slice(p)),g}]});var rZ=l("4vjcL"),h=l("4VVRT"),ez=l("iGnE2"),tO=l("c5KT9"),g=l("27fei"),k=l("5epbW"),e6=l("i66st"),rz=l("g3IlE"),rK=l("9NO3J"),rC=l("93WgD"),rX=l("jAPRv"),r$=rX.set,rQ=l("64gU6")(),e6=l("i66st");function r0(t){var e,r;this.promise=new t(function(t,n){if(void 0!==e||void 0!==r)throw TypeError("Bad Promise constructor");e=t,r=n}),this.resolve=e6(e),this.reject=e6(r)}ix=function(t){return new r0(t)};var r1={};r1=function(t){try{return{e:!1,v:t()}}catch(t){return{e:!0,v:t}}};var r2={},h=l("4VVRT"),r6=h.navigator;r2=r6&&r6.userAgent||"";var r5={},U=l("kvyZU"),k=l("5epbW");r5=function(t,e){if(U(t),k(e)&&e.constructor===t)return e;var r=ix(t);return(0,r.resolve)(e),r.promise};var r4="Promise",r3=h.TypeError,r8=h.process,r7=r8&&r8.versions,r9=r7&&r7.v8||"",nt=h[r4],ne="process"==tO(r8),nr=function(){},nn=iR=ix,ni=!!function(){try{// correct subclassing with @@species support
...
race:function(t){var e=this,r=nn(e),n=r.reject,i=r1(function(){rK(t,!1,function(t){e.resolve(t).then(r.resolve,n)})});return i.e&&n(i.v),r.promise}});var nh={},G=l("l3ykp"),np=G.f,M=l("frHNq"),nd=l("6dDiG"),ez=l("iGnE2"),rz=l("g3IlE"),rK=l("9NO3J"),ng=l("8MF5J"),nv=l("9vidL"),ny=l("gqSxK"),d=l("kLGkJ"),y=l("8ZJoP"),nm=y.fastKey,nb={},k=l("5epbW");nb=function(t,e){if(!k(t)||t._t!==e)throw TypeError("Incompatible receiver, "+e+" required!");return t};var nw=d?"_s":"size",nE=function(t,e){// fast case
...
add:function(t){return nh.def(nb(this,"Set"),t=0===t?0:t,t)}},nh);var h=l("4VVRT"),nS=l("a9Nrf")(0),v=l("lsTRt"),y=l("8ZJoP"),nx=l("5bYYj"),nO={},nd=l("6dDiG"),y=l("8ZJoP"),nR=y.getWeak,U=l("kvyZU"),k=l("5epbW"),rz=l("g3IlE"),rK=l("9NO3J"),nA=l("a9Nrf"),p=l("5hs3T"),nT=nA(5),n_=nA(6),nP=0,nj=function(t){return t._l||(t._l=new nU)},nU=function(){this.a=[]},nk=function(t,e){return nT(t.a,function(t){return t[0]===e})};nU.prototype={get:function(t){var e=nk(this,t);if(e)return e[1]},has:function(t){return!!nk(this,t)},set:function(t,e){var r=nk(this,t);r?r[1]=e:this.a.push([t,e])},delete:function(t){var e=n_(this.a,function(e){return e[0]===t});return~e&&this.a.splice(e,1),!!~e}},nO={getConstructor:function(t,e,r,n){var i=t(function(t,o){rz(t,i,e,"_i"),t._t=e,t._i=nP++,t._l=void 0,void 0!=o&&rK(o,r,t[n],t)});return nd(i.prototype,{// 23.3.3.2 WeakMap.prototype.delete(key)
// 23.4.3.3 WeakSet.prototype.delete(value)
delete:function(t){if(!k(t))return!1;var r=nR(t);return!0===r?nj(nb(this,e)).delete(t):r&&p(r,this._i)&&delete r[this._i]},// 23.3.3.4 WeakMap.prototype.has(key)
// 23.4.3.4 WeakSet.prototype.has(value)
has:function(t){if(!k(t))return!1;var r=nR(t);return!0===r?nj(nb(this,e)).has(t):r&&p(r,this._i)}}),i},def:function(t,e,r){var n=nR(U(e),!0);return!0===n?nj(t).set(e,r):n[t._i]=r,t},ufstore:nj};var k=l("5epbW"),nL=!h.ActiveXObject&&"ActiveXObject"in h,nF="WeakMap",nN=y.getWeak,nI=Object.isExtensible,nB=nO.ufstore,nM=function(t){return function(){return t(this,arguments.length>0?arguments[0]:void 0)}},nD={// 23.3.3.3 WeakMap.prototype.get(key)
get:function(t){if(k(t)){var e=nN(t);return!0===e?nB(nb(this,nF)).get(t):e?e[this._i]:void 0}},// 23.3.3.5 WeakMap.prototype.set(key, value)
set:function(t,e){return nO.def(nb(this,nF),t,e)}},nC=l("ds9kW")(nF,nM,nD,nO,!0,!0);nb&&nL&&(nx((i_=nO.getConstructor(nM,nF)).prototype,nD),y.NEED=!0,nS(["delete","has","get","set"],function(t){var e=nC.prototype,r=e[t];v(e,t,function(e,n){// store frozen objects on internal weakmap shim
if(k(e)&&!nI(e)){this._f||(this._f=new i_);var i=this._f[t](e,n);return"set"==t?this:i;// store all the rest on native weakmap
...
add:function(t){return nO.def(nb(this,nG),t,!0)}},nO,!1,!0);var g=l("27fei"),nV=l("gZewf"),nq=l("3V4xB"),U=l("kvyZU"),ex=l("iSghg"),eA=l("hxXsn"),k=l("5epbW"),h=l("4VVRT"),nW=h.ArrayBuffer,rC=l("93WgD"),nJ=nq.ArrayBuffer,nY=nq.DataView,nH=nV.ABV&&nW.isView,nZ=nJ.prototype.slice,nz=nV.VIEW,nK="ArrayBuffer";g(g.G+g.W+g.F*(nW!==nJ),{ArrayBuffer:nJ}),g(g.S+!nV.CONSTR*g.F,nK,{// 24.1.3.1 ArrayBuffer.isView(arg)
isView:function(t){return nH&&nH(t)||k(t)&&nz in t}}),g(g.P+g.U+g.F*l("c69UQ")(function(){return!new nJ(2).slice(1,void 0).byteLength}),nK,{// 24.1.4.3 ArrayBuffer.prototype.slice(start, end)
...
var i=r.prototype,o=M(k(i)?i:Object.prototype),a=Function.apply.call(t,o,e);return k(a)?a:o}});// 26.1.3 Reflect.defineProperty(target, propertyKey, attributes)
...
var C=l("dqZxD"),tw=l("hGDaq"),p=l("5hs3T"),g=l("27fei"),k=l("5epbW"),U=l("kvyZU");g(g.S,"Reflect",{get:function t(e,r/* , receiver */){var n,i,o=arguments.length<3?e:arguments[2];return U(e)===o?e[r]:(n=C.f(e,r))?p(n,"value")?n.value:void 0!==n.get?n.get.call(o):void 0:k(i=tw(e))?t(i,r,o):void 0}});// 26.1.7 Reflect.getOwnPropertyDescriptor(target, propertyKey)
...
var G=l("l3ykp"),C=l("dqZxD"),tw=l("hGDaq"),p=l("5hs3T"),g=l("27fei"),B=l("4TEjo"),U=l("kvyZU"),k=l("5epbW");g(g.S,"Reflect",{set:function t(e,r,n/* , receiver */){var i,o,a=arguments.length<4?e:arguments[3],s=C.f(U(e),r);if(!s){if(k(o=tw(e)))return t(o,r,n,a);s=B(0)}if(p(s,"value")){if(!1===s.writable||!k(a))return!1;if(i=C.f(a,r)){if(i.get||i.set||!1===i.writable)return!1;i.value=n,G.f(a,r,i)}else G.f(a,r,B(0,n));return!0}return void 0!==s.set&&(s.set.call(a,n),!0)}});// 26.1.14 Reflect.setPrototypeOf(target, proto)
var g=l("27fei"),n8=l("9bSkP");n8&&g(g.S,"Reflect",{setPrototypeOf:function(t,e){n8.check(t,e);try{return n8.set(t,e),!0}catch(t){return!1}}}),l("1DnRl");var g=l("27fei"),n7=l("bLEaL")(!0);g(g.P,"Array",{includes:function(t/* , fromIndex = 0 */){return n7(this,t,arguments.length>1?arguments[1]:void 0)}}),l("4HSJF")("includes");var n9=l("1DnRl");n9.Array.includes;var g=l("27fei"),it={},j=l("dGOhA"),k=l("5epbW"),eA=l("hxXsn"),ez=l("iGnE2"),ie=l("iv1sY")("isConcatSpreadable");it=function t(e,r,n,i,o,a,s,u){for(var f,c,l=o,h=0,p=!!s&&ez(s,u,3);h<i;){if(h in n){if(f=p?p(n[h],h,r):n[h],c=!1,k(f)&&(c=void 0!==(c=f[ie])?!!c:j(f)),c&&a>0)l=t(e,r,f,eA(f.length),l,a-1)-1;else{if(l>=9007199254740991)throw TypeError();e[l]=f}l++}h++}return l};var F=l("AEwlf"),eA=l("hxXsn"),e6=l("i66st"),ir=l("2Kvpz");g(g.P,"Array",{flatMap:function(t/* , thisArg */){var e,r,n=F(this);return e6(t),e=eA(n.length),r=ir(n,0),it(r,n,n,e,0,1,t,arguments[1]),r}}),l("4HSJF")("flatMap");var n9=l("1DnRl");n9.Array.flatMap;var g=l("27fei"),ii={},eA=l("hxXsn"),t3=l("lsuJ4"),ek=l("akpHM");ii=function(t,e,r,n){var i=String(ek(t)),o=i.length,a=void 0===r?" ":String(r),s=eA(e);if(s<=o||""==a)return i;var u=s-o,f=t3.call(a,Math.ceil(u/a.length));return f.length>u&&(f=f.slice(0,u)),n?f+i:i+f};// https://github.com/zloirock/core-js/issues/280
...
(this.arg=e),g}},t}({});try{regeneratorRuntime=iF}catch(t){// This module should not be running in strict mode, so the above
...
"object"==typeof globalThis?globalThis.regeneratorRuntime=iF:Function("r","regeneratorRuntime = r")(iF)}var iN=(r=l("440t5"))&&r.__esModule?r:{default:r};function iI(t,e){return function(){return t.apply(e,arguments)}}iN.default._babelPolyfill&&"undefined"!=typeof console&&console.warn&&console.warn("@babel/polyfill is loaded more than once on this page. This is probably not desirable/intended and may have consequences if different versions of the polyfills are applied sequentially. If you do need to load the polyfill more than once, use @babel/polyfill/noConflict instead to bypass the warning."),iN.default._babelPolyfill=!0;// utils is a library of generic helper functions non-specific to axios
...
["object","boolean","number","function","string","symbol"].forEach((t,e)=>{aU[t]=function(r){return typeof r===t||"a"+(e<1?"n ":" ")+t}});let ak={};/**
...
return(r,i,o)=>{if(!1===t)throw new oo(n(i," has been removed"+(e?" in "+e:"")),oo.ERR_DEPRECATED);return e&&!ak[i]&&(ak[i]=!0,// eslint-disable-next-line no-console
console.warn(n(i," has been deprecated since v"+e+" and will be removed in the near future"))),!t||t(r,i,o)}};var aL={assertOptions:/**
 ...
 */class aN{constructor(t){this.defaults=t,this.interceptors={request:new o3,response:new o3}}/**
   ...
   */request(t,e){let r,n;"string"==typeof t?(e=e||{}).url=t:e=t||{},e=aP(this.defaults,e);let{transitional:i,paramsSerializer:o,headers:a}=e;void 0!==i&&aL.assertOptions(i,{silentJSONParsing:aF.transitional(aF.boolean),forcedJSONParsing:aF.transitional(aF.boolean),clarifyTimeoutError:aF.transitional(aF.boolean)},!1),null!=o&&(oi.isFunction(o)?e.paramsSerializer={serialize:o}:aL.assertOptions(o,{encode:aF.function,serialize:aF.function},!0)),// Set config.method
...
let u=[],f=!0;this.interceptors.request.forEach(function(t){("function"!=typeof t.runWhen||!1!==t.runWhen(e))&&(f=f&&t.synchronous,u.unshift(t.fulfilled,t.rejected))});let c=[];this.interceptors.response.forEach(function(t){c.push(t.fulfilled,t.rejected)});let l=0;if(!f){let t=[aT.bind(this),void 0];for(t.unshift.apply(t,u),t.push.apply(t,c),n=t.length,r=Promise.resolve(e);l<n;)r=r.then(t[l++],t[l++]);return r}n=u.length;let h=e;for(l=0;l<n;){let t=u[l++],e=u[l++];try{h=t(h)}catch(t){e.call(this,t);break}}try{r=aT.call(this,h)}catch(t){return Promise.reject(t)}for(l=0,n=c.length;l<n;)r=r.then(c[l++],c[l++]);return r}getUri(t){t=aP(this.defaults,t);let e=am(t.baseURL,t.url);return o4(e,t.params,t.paramsSerializer)}}oi.forEach(["delete","get","head","options"],function(t){/*eslint func-names:0*/aN.prototype[t]=function(e,r){return this.request(aP(r||{},{method:t,url:e,data:(r||{}).data}))}}),oi.forEach(["post","put","patch"],function(t){/*eslint func-names:0*/function e(e){return function(r,n,i){return this.request(aP(i||{},{method:t,headers:e?{"Content-Type":"multipart/form-data"}:{},url:r,data:n}))}}aN.prototype[t]=e(),aN.prototype[t+"Form"]=e(!0)});/**
 ...
 */function t(e){let r=new aN(e),n=iI(aN.prototype.request,r);return oi.extend(n,aN.prototype,r,{allOwnKeys:!0}),oi.extend(n,r,null,{allOwnKeys:!0}),// Factory for creating new instances
n.create=function(r){return t(aP(e,r))},n}(ao);// Expose Axios class to allow class inheritance
aM.Axios=aN,// Expose Cancel & CancelToken
...
let{Axios:aD,AxiosError:aC,CanceledError:aG,isCancel:aV,CancelToken:aq,VERSION:aW,all:aJ,Cancel:aY,isAxiosError:aH,spread:aZ,toFormData:az,AxiosHeaders:aK,HttpStatusCode:aX,formToJSON:a$,getAdapter:aQ,mergeConfig:a0}=aM,a1=(t,e,r=5)=>{a2();let n=`<div class="alert alert--${t}">${e}</div>`;document.querySelector("body").insertAdjacentHTML("afterbegin",n),window.setTimeout(a2,1e3*r)},a2=()=>{let t=document.querySelector(".alert");t&&t.parentElement.removeChild(t)},a6=async(t,e)=>{try{let r=await aM({method:"POST",url:"/api/v1/users/login",data:{email:t,password:e}});"success"===r.data.status&&(a1("success","Logged in successfully!"),window.setTimeout(()=>{location.assign("/")},1e3))}catch(t){a1("error",t.response.data.message)}},a5=async()=>{try{let t=await aM({method:"GET",url:"/api/v1/users/logout"});// server reload
"success"===t.data.status&&location.assign("/")}catch(t){a1("error","Error when logging out! Try again.")}},a4=async(t,e,r,n)=>{try{let i=await aM({method:"POST",url:"/api/v1/users/signup",data:{name:t,email:e,password:r,passwordConfirm:n}});"success"===i.data.status&&(a1("success","Account created successfully!"),window.setTimeout(()=>{location.assign("/")},1e3))}catch(t){a1("error",t.response.data.message)}},a3=async(t,e)=>{try{let r="password"===e?"/api/v1/users/updatePassword":"/api/v1/users/updateMe",n=await aM({method:"PATCH",url:r,data:t});"success"===n.data.status&&(a1("success",`${e} updated successfully!`),window.setTimeout(()=>{location.reload()},2e3))}catch(t){a1("error",t.response.data.message)}},a8=Stripe("pk_test_51NojgRFcZkqRpT2CJ0r1RzZoCcA3epvhnDaGeIdykiwdQJK40yMMZVkHFCXdoEMRuWntNinHOAlUznlkSw4W35AP00ltUSEWQk"),a7=async t=>{try{// 1. Get checkout session from API
let e=await aM(`/api/v1/bookings/checkout-session/${t}`);// 2. Create checkout form + charge credit card
await a8.redirectToCheckout({sessionId:e.data.session.id})}catch(t){console.log(t),a1("error",t)}},a9=document.querySelector(".form--login"),st=document.getElementById("map"),se=document.querySelector(".nav__el--logout"),sr=document.querySelector(".form--signup"),sn=document.querySelector(".form-user-data"),si=document.querySelector(".form-user-password"),so=document.getElementById("book-tour"),sa=document.querySelector("body").dataset.alert;// DELEGATION
if(st){let t=JSON.parse(st.dataset.locations);(t=>{var e=L.map("map",{scrollWheelZoom:!1,zoomSnap:.25,zoomControl:!1}).setView([35.111745,-120.113491],4.75),r=L.control.zoom({position:"topright"}).addTo(e),n=r._zoomInButton,i=r._zoomOutButton;// Change the width and height of the buttons
...
o.extend([i,n])}),e.fitBounds(o,{paddingTopLeft:[100,200],paddingBottomRight:[100,200]})})(t)}a9&&a9.addEventListener("submit",t=>{let e=document.getElementById("email").value,r=document.getElementById("password").value;t.preventDefault(),a6(e,r)}),se&&se.addEventListener("click",a5),sr&&sr.addEventListener("submit",t=>{let e=document.getElementById("name").value,r=document.getElementById("email").value,n=document.getElementById("password").value,i=document.getElementById("passwordConfirm").value;t.preventDefault(),a4(e,r,n,i)}),sn&&sn.addEventListener("submit",t=>{t.preventDefault();let e=new FormData;e.append("name",document.getElementById("name").value),e.append("email",document.getElementById("email").value),e.append("photo",document.getElementById("photo").files[0]),a3(e,"data")}),si&&si.addEventListener("submit",async t=>{t.preventDefault(),document.querySelector(".btn--save-password").textContent="Updating...";let e=document.getElementById("password-current").value,r=document.getElementById("password").value,n=document.getElementById("password-confirm").value;await a3({passwordCurrent:e,password:r,passwordConfirm:n},"password"),document.querySelector(".btn--save-password").textContent="Save password",document.getElementById("password-current").value="",document.getElementById("password").value="",document.getElementById("password-confirm").value=""}),so&&so.addEventListener("click",t=>{t.target.textContent="Processing...";// e.target is the element which was clicked
let{tourId:e}=t.target.dataset;a7(e)}),alert&&a1("success",sa,20)})();//# sourceMappingURL=bundle.js.map
